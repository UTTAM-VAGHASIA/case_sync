                                  ...
                                  if (_formKey.currentState!.validate()) {
                                    ...
                                    try {
                                      var requestBody = {
                                        ...
                                        "stage": _selectedCaseStage,
                                        "court_id": _courtList.firstWhere(
                                            (court) =>
                                                court['name'] ==
                                                _selectedCourtName)['id'],
                                        "handle_by": _selectedHandler,
                                        "company_id": _selectedCompany,
                                        "applicant": _applicantController.text,
                                        "complainant_advocate":
                                            _complainantAdvocateController.text,
                                        "opponent": _opponentController.text,
                                        "respondent_advocate":
                                            _respondentAdvocateController.text,
      ...
      children: [
        ...
        SizedBox(
          ...
          child: DropdownButtonFormField<String>(
            ...
            value: label == 'Court Name'
                ? value
                : items.any((item) => item['id'] == value)
                    ? value
                    : null,
            items: label == 'Court Name'
                ? items.map((item) {
