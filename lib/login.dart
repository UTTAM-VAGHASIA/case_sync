...
import 'api_response.dart'; // Import ApiResponse for API interactions
    ...
    if (_formKey.currentState!.validate()) {
      ...
      if (response['success'] == true) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => HomeScreen(responseBody: response['data'].toString()),
          ),
        );
      } else {
        setState(() {
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                SvgPicture.asset('assets/casesync_text.svg'),
